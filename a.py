...
# # ---------------------------
# # Custom LangChain LLM wrapper for Claude API (FIXED)
# # ---------------------------
# class AnthropicChatLLM(LLM):
#     model_name: str = "claude-3-5-sonnet-20241022"  # Updated model name
#     max_tokens: int = 1000
...
#             # FIXED: Correct response parsing for Messages API
...
#     )
# except Exception:
#     # Fallback to downloading model if local path doesn't exist
...
#             # Use invoke instead of run (LangChain deprecation warning)
...
#     st.markdown("""
#     Upload PDF files and ask questions about their content. The app uses:
...
#                         st.info(f"Processed {len(text_chunks)} text chunks from {len(pdf_docs)} PDF(s)")
